...
/*
NOTE (2026-01-01): A large block of corrupted/duplicate content was accidentally embedded
inside GAME1_QUESTIONS (including `var` declarations and partial GAME5 data), which breaks
parsing and prevents GAMES_DATA from being defined.

That block is intentionally disabled to keep the app bootable.
  ...
  },
  {
    ...
    choicesPa: [
      "ਮਾਫ਼ ਕਰਨਾ—ਮੈਂ ਗਲਤ ਫ਼ਾਈਲ ਭੇਜੀ ਸੀ। ਇਹ ਸਹੀ ਫ਼ਾਈਲ ਹੈ।",
      "ਤੁਸੀਂ ਗਲਤ ਹੋ।",
      "ਮੈਨੂੰ ਪਰਵਾਹ ਨਹੀਂ।",
      "ਹੋਮਵਰਕ ਹੋ ਗਿਆ।"
    ],
  ...
  },
  {
    ...
    choicesEn: [
      "I'm studying right now—can I text you later?",
      "Stop texting me forever.",
      "You're so annoying.",
      "Texting is stupid."
    ],
    choicesPa: [
      "ਮੈਂ ਹੁਣ ਪੜ੍ਹ ਰਿਹਾ/ਰਹੀ ਹਾਂ—ਕੀ ਮੈਂ ਬਾਅਦ ਵਿੱਚ ਮੈਸੇਜ ਕਰਾਂ?",
      "ਹਮੇਸ਼ਾਂ ਲਈ ਮੈਸੇਜ ਨਾ ਕਰ।",
      "ਤੂੰ ਬਹੁਤ ਚਿੜਾਉਂਦਾ/ਚਿੜਾਉਂਦੀ ਹੈਂ।",
      "ਮੈਸੇਜ ਕਰਨਾ ਬੇਕਾਰ ਹੈ।"
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choicesEn: [
      "Can you explain number 3 to me?",
      "Do it for me.",
      "This homework is trash.",
      "I hate homework."
    ],
    choicesPa: [
      "ਕੀ ਤੂੰ ਮੈਨੂੰ ਨੰਬਰ 3 ਸਮਝਾ ਸਕਦਾ/ਸਕਦੀ ਹੈਂ?",
      "ਤੂੰ ਮੇਰੇ ਲਈ ਕਰ ਦੇ।",
      "ਇਹ ਹੋਮਵਰਕ ਬਕਵਾਸ ਹੈ।",
      "ਮੈਨੂੰ ਹੋਮਵਰਕ ਨਫ਼ਰਤ ਹੈ (ਅਜੀਬ)।"
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choicesPa: [
      "ਮੈਂ ਥੋੜ੍ਹਾ ਦੇਰ ਨਾਲ ਆ ਰਿਹਾ/ਰਹੀ ਹਾਂ—10 ਮਿੰਟ ਵਿੱਚ ਪਹੁੰਚਦਾ/ਪਹੁੰਚਦੀ ਹਾਂ।",
      "ਮੈਂ ਦੇਰ। ਬਾਈ।",
      "ਹਮੇਸ਼ਾਂ ਉਡੀਕ ਕਰ।",
      "ਤੂੰ ਦੇਰ ਹੈਂ।"
    ],
  ...
  // ---------- HARD (5) ----------
  {
    ...
    choicesEn: [
      "Nah, I'm going to class. You should come too.",
      "No. You're bad.",
      "Fine, let's skip every time.",
      "Class is stupid."
    ],
    choicesPa: [
      "ਨਹੀਂ, ਮੈਂ ਕਲਾਸ ਜਾ ਰਿਹਾ/ਰਹੀ ਹਾਂ। ਤੂੰ ਵੀ ਆ ਜਾ।",
      "ਨਹੀਂ। ਤੂੰ ਮਾੜਾ ਹੈਂ।",
      "ਹਾਂ, ਹਰ ਵਾਰੀ ਛੱਡੀਏ।",
      "ਕਲਾਸ ਬੇਕਾਰ ਹੈ।"
    ],
  ...
  },
  {
    ...
    choicesEn: [
      "I did want to invite you—there was a misunderstanding.",
      "Yeah, I didn't want you there.",
      "Whatever.",
      "You're too sensitive."
    ],
    choicesPa: [
      "ਮੈਂ ਤਾਂ ਤੈਨੂੰ ਬੁਲਾਉਣਾ ਚਾਹੁੰਦਾ/ਚਾਹੁੰਦੀ ਸੀ—ਗਲਤਫ਼ਹਮੀ ਹੋ ਗਈ।",
      "ਹਾਂ, ਮੈਂ ਨਹੀਂ ਚਾਹੁੰਦਾ ਸੀ।",
      "ਛੱਡ।",
      "ਤੂੰ ਬਹੁਤ ਜ਼ਿਆਦਾ ਸੰਵੇਦਨਸ਼ੀਲ ਹੈਂ।"
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choicesEn: [
      "I can't send answers, but I can help you understand it.",
      "Sure—I'll send everything.",
      "No. Don't talk to me.",
      "Cheating is fine."
    ],
    choicesPa: [
      "ਮੈਂ ਉੱਤਰ ਨਹੀਂ ਭੇਜ ਸਕਦਾ/ਸਕਦੀ, ਪਰ ਮੈਂ ਸਮਝਣ ਵਿੱਚ ਮਦਦ ਕਰ ਸਕਦਾ/ਸਕਦੀ ਹਾਂ।",
      "ਹਾਂ—ਮੈਂ ਸਾਰੇ ਭੇਜ ਦਿਆਂਗਾ/ਦਿਆਂਗੀ।",
      "ਨਹੀਂ। ਮੇਰੇ ਨਾਲ ਗੱਲ ਨਾ ਕਰ।",
      "ਚੀਟ ਕਰਨੀ ਠੀਕ ਹੈ।"
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choicesEn: [
      "Hey—can you finish your part by tonight? We need it to submit.",
      "You're useless. Do it.",
      "I'll do everything. You do nothing.",
      "Whatever, it doesn't matter."
    ],
    choicesPa: [
      "ਹੇ—ਕੀ ਤੂੰ ਅੱਜ ਰਾਤ ਤੱਕ ਆਪਣਾ ਹਿੱਸਾ ਮੁਕਾ ਸਕਦਾ/ਸਕਦੀ ਹੈਂ? ਸਬਮਿਟ ਲਈ ਚਾਹੀਦਾ।",
      "ਤੂੰ ਨਿਕੰਮਾ ਹੈਂ। ਕਰ ਕੰਮ।",
      "ਮੈਂ ਸਭ ਕਰ ਲਾਂਗਾ/ਲਾਂਗੀ। ਤੂੰ ਕੁਝ ਨਾ ਕਰ।",
      "ਛੱਡ, ਕੋਈ ਗੱਲ ਨਹੀਂ।"
    // -------------------- GAME QUESTION BANKS --------------------
    ...
    var GAME1_QUESTIONS = [
      ...
      // Phase 5 (+40): New (10 per game; mixed everyday themes)
      { sentence: "The baby sleeps now", question: "Tap the verb", correctWord: "sleeps", trackId: "T_ACTIONS", hintEn: "Verb = action word.", hintPa: "ਕਿਰਿਆ (verb) = ਕੰਮ ਵਾਲਾ ਸ਼ਬਦ।", explanationEn: "Sleeps is the action.", explanationPa: "Sleeps ਕੰਮ/ਕਿਰਿਆ ਦੱਸਦਾ ਹੈ।" },
      { sentence: "A yellow bus stops here", question: "Tap the adjective", correctWord: "yellow", trackId: "T_DESCRIBE", hintEn: "Adjectives describe.", hintPa: "Adjective ਵਰਣਨ ਕਰਦਾ ਹੈ।", explanationEn: "Yellow describes the bus.", explanationPa: "Yellow ਬੱਸ ਦਾ ਵਰਣਨ ਕਰਦਾ ਹੈ।" },
      { sentence: "My backpack is heavy", question: "Tap the noun", correctWord: "backpack", trackId: "T_WORDS", hintEn: "Noun = thing.", hintPa: "Noun = ਚੀਜ਼।", explanationEn: "Backpack is a thing.", explanationPa: "Backpack ਇੱਕ ਚੀਜ਼ ਹੈ।" },
      { sentence: "The turtle moves slowly", question: "Tap the adverb", correctWord: "slowly", trackId: "T_ACTIONS", hintEn: "Adverb tells how.", hintPa: "Adverb ਦੱਸਦਾ ਹੈ ਕਿਵੇਂ।", explanationEn: "Slowly tells how it moves.", explanationPa: "Slowly ਦੱਸਦਾ ਹੈ ਕਿਵੇਂ ਹਿਲਦਾ ਹੈ।" },
      { sentence: "The ball is behind the door", question: "Tap the preposition", correctWord: "behind", trackId: "T_SENTENCE", hintEn: "Prepositions show place.", hintPa: "Preposition ਥਾਂ ਦੱਸਦਾ ਹੈ।", explanationEn: "Behind shows where the ball is.", explanationPa: "Behind ਦੱਸਦਾ ਹੈ ਗੇਂਦ ਕਿੱਥੇ ਹੈ।" },
      { sentence: "Do you want tea or milk", question: "Tap the conjunction", correctWord: "or", trackId: "T_SENTENCE", hintEn: "Conjunction joins choices.", hintPa: "Conjunction ਚੋਣਾਂ ਜੋੜਦਾ ਹੈ।", explanationEn: "Or connects two choices.", explanationPa: "Or ਦੋ ਚੋਣਾਂ ਜੋੜਦਾ ਹੈ।" },
      { sentence: "Hooray! We won the game", question: "Tap the interjection", correctWord: "Hooray", trackId: "T_READING", hintEn: "Interjection shows a feeling.", hintPa: "Interjection ਭਾਵਨਾ ਦੱਸਦਾ ਹੈ।", explanationEn: "Hooray shows excitement.", explanationPa: "Hooray ਖੁਸ਼ੀ/ਉਤਸ਼ਾਹ ਦੱਸਦਾ ਹੈ।" },
      { sentence: "A puppy barks", question: "Tap the article", correctWord: "A", trackId: "T_SENTENCE", hintEn: "A/An/The are articles.", hintPa: "A/An/The articles ਹਨ।", explanationEn: "A is an article before a noun.", explanationPa: "A noun ਤੋਂ ਪਹਿਲਾਂ ਆਉਣ ਵਾਲਾ article ਹੈ।" },
      { sentence: "They share snacks", question: "Tap the pronoun", correctWord: "They", trackId: "T_READING", hintEn: "Pronoun replaces a name.", hintPa: "Pronoun ਨਾਮ ਦੀ ਥਾਂ ਆਉਂਦਾ ਹੈ।", explanationEn: "They is a pronoun.", explanationPa: "They ਇੱਕ pronoun ਹੈ।" },
      { sentence: "Her sparkly shoes shine", question: "Tap the adjective", correctWord: "sparkly", trackId: "T_DESCRIBE", hintEn: "Adjectives tell what kind.", hintPa: "Adjective ਦੱਸਦਾ ਹੈ ਕਿਹੋ ਜਿਹਾ।", explanationEn: "Sparkly describes shoes.", explanationPa: "Sparkly ਜੁੱਤਿਆਂ ਦਾ ਵਰਣਨ ਕਰਦਾ ਹੈ।" }
    ];

    // Game 2: Parts of Speech
    // Authoring schema: { word: string, correctPartId: string, trackId: string }
    // NOTE: This bank was restored to keep the app loadable.
    var GAME2_QUESTIONS = [
